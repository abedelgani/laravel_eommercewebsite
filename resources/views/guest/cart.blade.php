        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        @foreach ($commandes->lignecommandes as $lc )
                        <tr>
                            <td class="align-middle"><img src="{{ asset('uploads') }}/{{ $lc->produit->photo}}" alt="" style="width: 50px;">{{ $lc->produit->nom }}</td>
                            ...
                            <td class="align-middle">
                                <a href="/client/lc/{{ $lc->id }}/destroy" class="btn btn-sm btn-primary"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                         @endforeach
                    </tbody>
            ...
            <div class="col-lg-4">
                <form action="/client/checkout" method="POST">
                    @csrf
                    <input type="hidden" value="{{ $commandes->id }}" name="commande">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium">{{$commandes->gettotal() }}TND</h6>
                        </div>
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold">{{ $commandes->gettotal()+10 }}</h5>
                        </div>
