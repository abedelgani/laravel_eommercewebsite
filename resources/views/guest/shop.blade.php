    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-12">
            ...
            <div class="border-bottom mb-4 pb-4">
                ...
                <form action="{{ route('guest.shop') }}" method="GET">
                    <input type="text" name="min_price" placeholder="minimum prix" class="form-control">
                    <input type="text" name="max_price" placeholder="Maximum prix" class="form-control"><br>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="{{ asset('uploads') }}/{{ $produit->photo }}" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">{{ $produit->nom }}</h6>
                            <div class="d-flex justify-content-center">
                                <h6>{{ $produit->price }} TND</h6><h6 class="text-muted ml-2"><del></del></h6>
                            </div>
                            <P>{{ $produit->description }}</P>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="/produit/details/{{ $produit->id }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                            <a href="/produit/details/{{ $produit->id }}" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                        </div>
                    </div>
                </div>
                @endforeach
