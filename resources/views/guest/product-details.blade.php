   ...
   @include('inc.guest.navbar')
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="mb-4">{{ count($produit->reviews) }} Review for {{ $produit->nom }}</h4>
                                @foreach ($produit->reviews as $review )
                                <div class="media mb-4">
                                    <img src="{{ asset('mainassets/img/user.png') }}" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="/client/store/review" method="POST">
                                    @csrf
                                    <p class="mb-0 mr-2"> Votre note * :</p>
                                    <input type="number" class="form-control" max="5" min="1" name="rate">
    ...
    <div class="container-fluid py-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">les autres produits</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">{{ $prod->nom }}</h6>
                            <div class="d-flex justify-content-center">
                                <h6>{{ $prod->price }}</h6><h6 class="text-muted ml-2"><del></del></h6>
                            </div>
                        </div>
