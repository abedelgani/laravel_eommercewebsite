        ...
        <ul class="navbar-nav flex-column" id="navbarVerticalNav">
          ...
          <li class="nav-item">
            ...
            <ul class="nav collapse parent" id="e-commerce">
              <li class="nav-item"><a class="nav-link" href="/admin/categorie" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-text">categories</span></div>
                </a></li>
              <li class="nav-item"><a class="nav-link" href="/admin/produits" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-text">Products</span></div>
                </a></li>
                <li class="nav-item"><a class="nav-link" href="/admin/client" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-text">clients</span></div>
                  </a></li>
              <li class="nav-item"><a class="nav-link" href="/admin/commandes" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center"><span class="nav-link-text">commandes</span></div>
                </a></li>
                <li class="nav-item"><a class="nav-link" href="/admin/contact" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-text">message utilisateur</span></div>
                  </a></li>
            </ul>
          </li>
        </ul>
